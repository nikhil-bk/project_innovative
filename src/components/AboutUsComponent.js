                ...
                <div className="row">
                    <div className="about_home_1  clearfix">
                        <div className="col-sm-12">
                            ...
                            <p className='text-justify'>Welcome to <span className='col_1 fw-bold'>Innovative Electrical Solutions,</span> your one-stop destination for top-notch electrical contracting services. With a proven track record of excellence and a team of dedicated professionals, we are your reliable partner for all your electrical needs.</p>
                        </div>
                    </div>
